...
static void cfftz (int is, int m, int n, std::vector<std::vector<dcomplex> > &x, std::vector<std::vector<dcomplex> > &y);
static void fftz2 (int is, int l, int m, int n, int ny, int ny1, dcomplex u[NX], std::vector<std::vector<dcomplex> > &x, std::vector<std::vector<dcomplex> > &y);
...
static void cffts1(int is, int d[3], std::vector<std::vector<std::vector<dcomplex> > > &x, std::vector<std::vector<std::vector<dcomplex> > > &xout) {
	...
	{
		std::vector<std::vector<dcomplex> > y0 (NX, std::vector<dcomplex> (FFTBLOCKPAD));
		std::vector<std::vector<dcomplex> > y1 (NX, std::vector<dcomplex> (FFTBLOCKPAD));
